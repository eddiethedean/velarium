...
Design background and ecosystem context: **[docs/design.md](docs/design.md)** and **[docs/valarium.md](docs/valarium.md)**. Annotation coverage: **[docs/supported-annotations.md](docs/supported-annotations.md)**.
