...
Downstream packages (e.g. [**velotype** on PyPI](https://pypi.org/project/velotype/)) consume this IR to emit `.pyi` stubs and other artifacts. The IR contract is in [docs/modelspec-ir.md](https://github.com/eddiethedean/velarium/blob/main/docs/modelspec-ir.md); JSON **`format_version`** and migration notes are in [docs/migration-ir.md](https://github.com/eddiethedean/velarium/blob/main/docs/migration-ir.md); the hand-maintained public symbol list is [docs/api-reference.md](https://github.com/eddiethedean/velarium/blob/main/docs/api-reference.md); pre-1.0 stability expectations are in [docs/stability.md](https://github.com/eddiethedean/velarium/blob/main/docs/stability.md). How Python annotations map to the IR is in [docs/supported-annotations.md](https://github.com/eddiethedean/velarium/blob/main/docs/supported-annotations.md); stub consumer guarantees are summarized in [docs/stub-compatibility.md](https://github.com/eddiethedean/velarium/blob/main/docs/stub-compatibility.md); builders and optional extras are in [docs/model-sources.md](https://github.com/eddiethedean/velarium/blob/main/docs/model-sources.md). Ecosystem context is in [docs/valarium.md](https://github.com/eddiethedean/velarium/blob/main/docs/valarium.md) and [docs/design.md](https://github.com/eddiethedean/velarium/blob/main/docs/design.md).
...
- [User guides — Velarium library](https://github.com/eddiethedean/velarium/blob/main/docs/guides/velarium-library.md)  
